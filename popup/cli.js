module.exports = function(waw){
	waw.exe('ng g c '+waw.path, function(){
		...
		let html = waw.fs.readFileSync(__dirname+'/popup/component.html', 'utf8');
		...
		let scss = waw.fs.readFileSync(__dirname+'/popup/component.scss', 'utf8');
		...
		let ts = waw.fs.readFileSync(__dirname+'/popup/component.ts', 'utf8');
